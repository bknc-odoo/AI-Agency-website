...
const DataShowcase: React.FC = () => {
  ...
  const dataTypes: DataType[] = translations.dataShowcase.dataTypes.map((item: any) => ({
    ...item,
    icon: getIconForDataType(item.id)
  }))

  function getIconForDataType(id: string): React.ReactNode {
    switch (id) {
      case 'office-chaos':
        return (
  ...
  function getPipelineIcon(index: number): React.ReactNode {
    const icons = [
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4m14-7l-5 5-5-5" stroke="currentColor" strokeWidth="2"/></svg>,
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z" stroke="currentColor" strokeWidth="2"/></svg>,
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M9.5 2A2.5 2.5 0 007 4.5v15A2.5 2.5 0 009.5 22h5a2.5 2.5 0 002.5-2.5v-15A2.5 2.5 0 0014.5 2h-5z" stroke="currentColor" strokeWidth="2"/><path d="M10 8h4m-4 4h4m-4 4h4" stroke="currentColor" strokeWidth="2"/></svg>,
